...
public class CoreVal {

    public static String[] states = {  "Abia",
            "Adamawa",
            "Anambra",
            "Akwa Ibom",
            "Bauchi",
    ...
    public static String[] countries = {"Afghanistan","Albania","Algeria","Andorra","Angola","Anguilla","Antigua &amp; Barbuda","Argentina","Armenia","Aruba","Australia","Austria","Azerbaijan","Bahamas"
